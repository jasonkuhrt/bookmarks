...
export const WorkspaceBookmarkNode: Schema.Schema<WorkspaceBookmarkNode> = Schema.mutable(
  Schema.Struct({
...
export const WorkspaceSeparatorNode: Schema.Schema<WorkspaceSeparatorNode> = Schema.mutable(
  Schema.Struct({
...
export const WorkspaceRawNode: Schema.Schema<WorkspaceRawNode> = Schema.mutable(
  Schema.Struct({
...
export const WorkspaceNode: Schema.Schema<WorkspaceNode> = Schema.mutable(
  Schema.Union(
    WorkspaceBookmarkNode,
...
export const WorkspaceSection: Schema.Schema<WorkspaceNode[]> = Schema.mutable(
  Schema.Array(WorkspaceNode),
);
export type WorkspaceSection = WorkspaceNode[];

export const WorkspaceFolderNode: Schema.Schema<WorkspaceFolderNode> = Schema.mutable(
  Schema.Struct({
...
export const WorkspaceTree: Schema.Schema<WorkspaceTree> = Schema.mutable(
  Schema.Struct({
...
export const WorkspaceTarget: Schema.Schema<WorkspaceTarget> = Schema.mutable(
  Schema.Struct({
...
export const WorkspaceScopedTrees: Schema.Schema<WorkspaceScopedTrees> = Schema.mutable(
  Schema.Struct({
    global: WorkspaceTree,
...
export const WorkspaceFile: Schema.Schema<WorkspaceFile> = Schema.mutable(
  Schema.Struct({
